namespace HomeworkWeek1.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw客戶關聯資料Repository Getvw客戶關聯資料Repository()
		{
			var repository = new vw客戶關聯資料Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw客戶關聯資料Repository Getvw客戶關聯資料Repository(IUnitOfWork unitOfWork)
		{
			var repository = new vw客戶關聯資料Repository();
